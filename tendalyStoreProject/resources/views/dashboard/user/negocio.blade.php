...
@section('contenido')
    ...
    @if (!$negocio)
        <div class="bg-white p-6 rounded-lg shadow-md text-center">
            ...
            <p class="text-gray-600 mb-6">Parece que no has configurado tu negocio en TendalyStore. ¡Es muy fácil comenzar! Crea tu negocio ahora y empieza a vender tus productos.</p>
            <a href="{{route('negocio.create')}}" class="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-6 rounded-lg focus:outline-none focus:shadow-outline transition duration-150 ease-in-out">
                Crear Nuevo Negocio
            </a>
        </div>
    @else
            ...
            <div class="bg-white p-6 rounded-lg shadow-md col-span-1 md:col-span-2">
                ...
                <div class="text-sm text-gray-600">
                    <p class="flex items-center mb-1">
                        <svg class="w-4 h-4 mr-2 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                    ...
                    <p class="flex items-center">
                        ...
                        Ubicación: <span class="ml-1 font-medium">{{$negocio->distrito->nombre}} {{$negocio->departamento->nombre}} Perú</span> 
                    </p>
                </div>
                <div class="mt-6 flex justify-end space-x-3">
                    <button class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline transition duration-150 ease-in-out">
                        Editar Información
                    </button>
                    <a href="{{route('negocio.index',$negocio->nombre)}}" class="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline transition duration-150 ease-in-out">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md flex flex-col justify-between">
                <div>
                    ...
                    @if ($negocio->productos->isEmpty())
                        ...
                        <a href="{{ route('producto.create') }}" class="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline transition duration-150 ease-in-out">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md mb-8">
            ...
            <div class="mt-6">
                ...
                <div class="mt-4 text-right">
                    <a href="#" class="text-red-600 hover:text-red-700 font-semibold">Ver Todas las Ventas &rarr;</a>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <p class="text-sm text-gray-500 mt-3">Aquí se mostraría una visualización de tus ventas a lo largo del tiempo.</p>
        </div>
    @endif
@endsection