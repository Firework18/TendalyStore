        ...
        <div class="content-wrapper">
            ...
            <div class="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div
                    ...
                    <img src="{{ asset('assets/images/alimentacion.jpg') }}" alt="Alimentación"
                        class="w-full h-28 md:h-36 object-cover" />
                    <div class="p-3 md:p-4">
                        <h3 class="font-bold text-sm md:text-md mb-2 text-[var(--primary-blue)] line-clamp-2">
                            Alimentación
                        </h3>
                        ...
                        <a href="/catalogo"
                            class="block text-center text-xs text-white bg-red-500 py-2 rounded-full hover:bg-[#10386e] transition">Visitar
                            el catálogo</a>
                    </div>
                </div>
