    ...
    <form method="POST" wire:submit.prevent='editarNegocio' enctype="multipart/form-data" novalidate>
        ...
        <section class="bg-white p-6 rounded-lg custom-shadow mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                    <label for="departamento_id" class="block text-gray-700 text-sm font-semibold mb-2">Departamento
                        <span class="text-red-500">*</span></label>
                    <span class="font-light text-red-500">Departamento actual: {{ $departamento->nombre }}</span>
                ...
                <div>
                    <label for="provincia_id" class="block text-gray-700 text-sm font-semibold mb-2">Provincia
                        <span class="text-red-500">*</span></label>
                    <span class="font-light text-red-500">Provincia actual: {{ $provincia->nombre }}</span>
            ...
            <div>
                ...
                <span class="font-light text-red-500">Distrito actual: {{ $distrito->nombre }}</span>
        ...
        <section class="bg-white p-6 rounded-lg custom-shadow mb-6">
            <div class="mb-5 mt-8 p-6 border-t border-gray-200">
                ...
                <div class="justify-center my-5 sm:w-30 lg:w-9/12">
                    @if ($imagen)
                        Vista previa de la imágen actual:
                        <img src="{{ asset('/storage/negocios/' . $imagen) }}">
                    @endif
                    @if ($imagen_nueva)
