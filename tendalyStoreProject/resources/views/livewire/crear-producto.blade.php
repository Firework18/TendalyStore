<div class="bg-white p-8 rounded-xl shadow-lg max-w-3xl mx-auto">
        <form novalidate enctype="multipart/form-data" wire:submit.prevent='crearProducto'>
        <div class="mb-5">
        ...
        <div class="mb-5 mt-8 p-6 border-t border-gray-200">
            ...
            <p class="text-gray-500 text-sm mb-4 text-center">Sube una imagen para tu producto. Formato: JPG, PNG. Tamaño máximo: 2MB.</p>
            <label for="imagen" class="mb-2 block uppercase text-gray-700 font-bold text-sm sr-only">
                Seleccionar Imagen
            </label>
            <div class="flex items-center justify-center w-full">
                <label for="imagen" class="flex flex-col items-center justify-center w-full h-40 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors">
                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                        <svg class="w-10 h-10 mb-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 0115.9 6L16 6a3 3 0 013 3v10a2 2 0 01-2 2H7a2 2 0 01-2-2v-2m3-4l4-4m0 0l4 4m-4-4v12"></path></svg>
                        <p class="mb-2 text-sm text-gray-500"><span class="font-semibold">Haz click para subir</span> o arrastra y suelta</p>
                        <p class="text-xs text-gray-500">SVG, PNG, JPG or GIF (MAX. 2MB)</p>
                    </div>
                    <input id="imagen" wire:model="imagen" type="file" class="hidden" accept=".jpg,.jpeg,.png" />
                </label>
            </div>
