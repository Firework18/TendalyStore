...
<main class="container mx-auto mt-2 mb-8 p-1">
    <div class="mb-6 flex items-center text-gray-600 hover:text-gray-800 transition duration-150 ease-in-out">
        ...
        <a href="{{route('dashboard.negocio')}}" class="text-sm font-medium">Volver al negocio</a>
    </div>

    <h2 class="font-extrabold text-center text-4xl mb-8 p-3 text-gray-800">Crear Nuevo Producto</h2>
    <div>
